...
const OrderReceivedEmails = ({
  ...
  const baseUrl =
    process.env.NODE_ENV === "development"
      ? "http://localhost:3000"
      : "https://case-cobra-store.vercel.app";
        ...
        <Container style={container}>
          ...
          <Section style={paddingY}>
            <Row>
              ...
              >
                Please contact us if you have any questions. (if you will reply
...
export default OrderReceivedEmails;
